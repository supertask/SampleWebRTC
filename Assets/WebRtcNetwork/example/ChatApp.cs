...
public class ChatApp : MonoBehaviour
{
    ...
    //public string uSignalingUrl = "wss://localhost:12777/chatapp";
	public string uSignalingUrl = "wss://localhost:12777/chatapp";



    //public string uIceServer = "stun:because-why-not.com:12779";
	public string uIceServer = "stun:stun.services.mozilla.com:3478";
	//public string uIceServer = "stun:localhost:3478";
                    ...
                    case NetEventType.ServerInitialized:
                        {
							...
							Append("Server started. ID: " + evt.ConnectionId);
                    ...
                    case NetEventType.NewConnection:
                        {
							...
							Append("New local connection! address:" + evt.Info);
    ...
    private void HandleIncommingMessage(ref NetworkEvent evt)
    {
        ...
        if (mIsServer)
        {
            ...
            SendString(idAndMessage); //全員にメッセージを送る
            Append(idAndMessage);
        }
        else
        {
